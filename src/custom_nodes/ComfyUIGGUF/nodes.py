...
class CLIPLoaderGGUF:
    ...
    def load_clip(self, clip_name, type="stable_diffusion"):
        # On sait qu'on charge un GGUF, on utilise donc directement "clip_gguf".
        clip_path = folder_paths.get_full_path("clip_gguf", clip_name)

        # Si le chemin n'est pas trouv̩, lever une erreur claire.
        if clip_path is None:
            raise FileNotFoundError(f"Fichier CLIP GGUF non trouv̩ : {clip_name}. V̩rifiez que le dossier de mod̬les est correct.")
